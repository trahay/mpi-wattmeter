...
static void MPI_Send_init_epilog(CONST void* buffer MAYBE_UNUSED,
...
void mpif_send_init_(void* buffer,
		     int* count,
		     MPI_Fint* type,
		     int* dest,
		     int* tag,
